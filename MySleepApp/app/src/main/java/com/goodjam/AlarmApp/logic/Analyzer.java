...
package com.goodjam.AlarmApp.logic;
import android.util.Log;

import com.goodjam.AlarmApp.DB_Chart;
...
public class Analyzer {
	...
	public static ActivityReport analyzeAccel(ArrayList<ContentObject> objectArray, int samplingInterval, int totalTime) {
		...
		DB.insertDB(Integer.toString(nStepCount));
		Log.e("e","FUCK "+Integer.toString(nStepCount));
